  ...
  return (
    <div className='bg-black  min-h-screen w-full flex justify-center items-center'>
      ...
      <div className='w-full flex flex-col-reverse  justify-center sm:flex-row items-center  h-full'>
                  ...
                  <a href={`${URL}/auth/google`} className='p-4 text-sm text-wrap m-4 px-12 sm:w-[40%] w-[95%] sm:text-lg rounded-3xl h-[10%] text-slate-900 hover:shadow-lg hover:shadow-slate-800  transition duration-400 sora hover:animate-none  tracking-wider font-bold hover:-translate-y-0.5  google'>Continue with Google</a>
